...
public class StudentController {
    ...
    public ResponseEntity<?> getStudentsByInstructorId(@PathVariable String username) throws ResourceNotFoundException {

		List<Student> students = service.getStudentsByInstructorId(username);
